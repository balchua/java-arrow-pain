...
class IngestionBenchmarkTest {
    ...
    @Test
    @DisplayName("Ingestion benchmark — XML → DuckDB INSERT → ArrowIpc.export() — all types A through K")
    void ingestionBenchmarkAllTypes() throws Exception {
        ...
        results.add(runIngestion(TestPainFileSpecs.TYPE_I, SMALL_ALLOCATOR_LIMIT));
