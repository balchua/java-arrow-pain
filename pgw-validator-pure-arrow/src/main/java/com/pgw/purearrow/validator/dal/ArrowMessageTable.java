 ...
 * Java-heap objects are created until an actual row is read.
 * </p>
 *
 * <p>
 * Call {@link #close()} to release all Arrow off-heap memory when the table
 * is no longer needed.
 * </p>
 */
public final class ArrowMessageTable implements AutoCloseable {
    ...
    /**
     * Returns the {@code msg_id} value for row {@code i} in {@code batch}, or
     * {@code null}.
     */
    ...
    /**
     * Returns the {@code msg_initg_pty_nm} value for row {@code i}, or
     * {@code null}.
     */
